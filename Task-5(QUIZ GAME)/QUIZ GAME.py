...
class QuizApp:
    ...
    def load_quiz_data(self):
        # You can load your quiz data here, if it's in a JSON file.
        pass
    ...
    def create_widgets(self):
        ...
        self.show_widgets()  # Initially, show the widgets

    def show_widgets(self):
        for button in self.option_buttons:
            button.pack(pady=10, padx=20)  # Adjust padx for horizontal padding

        self.next_button.pack(pady=20, padx=20)  # Adjust padx for horizontal padding
